...
export default function StudioWrapper({ children }: StudioWrapperProps) {
  ...
  if (!config.features.enableStudio) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <p className="text-gray-600 mb-8">
            The Studio feature is currently disabled. You can enable it by setting <code className="bg-gray-100 px-2 py-1 rounded">enableStudio: true</code> in your configuration.
          </p>
          <Link
            href="/"
